...
def cookied_inputs(request):
    ...
    return render(request, 'test/cookied_inputs.html', context)

def jqnotebook_view(request):
    context = {'test': 'Yo!'}

    return render(request, 'test/jqnotebook.html', context)
...
def iipimage(request):
    ...
    return render(request, 'test/iipimage.html', context)

def api_view(request):
    context = {'test': 'Yo!'}

    return render(request, 'test/api.html', context)
...
def autocomplete_view(request):
    ...
    return render(request, 'test/autocomplete.html', context)
...
#                                 ).order_by('display_label').distinct()
    ...
    return render_to_response(request, 'test/map.html', context,
...
#         context['graphs'].append(g)
    ...
    ret = render(request, 'test/similar_graph.html', context)
