...
MIDDLEWARE = (
     'mezzanine.pages.middleware.PageMiddleware', # This MIDDLEWARE is also included in the tuple "MIDDLEWARE_CLASSES" below. There was an error in several pages prompting that the "mezzanine.pages.middleware.PageMiddleware" was not inlcuded in MIDDLEWARE.
...
"""    https://github.com/stephenmcd/mezzanine/blob/master/  mezzanine/mezzanine/project_template/project_name/settings.py
Copied it here from the link above. It is a complete example of MIDDLEWARE 
I used to also inlcude the "# 'mezzanine.pages.middleware.PageMiddleware'," in the MIDDLEWARE above.
...
#####################################
# APPLICATIONS DJANGO DEBUG TOOLBAR #
#####################################
...
if ENABLE_DEBUG_TOOLBAR:
    ...
    MIDDLEWARE += (
        ...
        "digipal.middleware.ViewLoggerMiddleware"
    )
