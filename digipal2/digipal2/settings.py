...
# os.path.join(PROJECT_ROOT, '<path to mezzanine>/mezzanine/mezzanine'),
#             os.path.join(PROJECT_ROOT, '<path to mezzanine>/mezzanine/mezzanine/blog/templates'),digipal-archetype/lib/python3.12/site-packages/mezzanine/blog/templates
